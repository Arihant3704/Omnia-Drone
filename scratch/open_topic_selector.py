...
def main():
    ...
    # Click "Topic Visualization" at (250, 103)
    print("Clicking 'Topic Visualization' at (250, 103)...")
    run_cmd("xdotool mousemove 250 103 click 1")
    time.sleep(1.5)
    ...
    with mss.mss() as sct:
        ...
        cv2.imwrite("/tmp/dialog_open.png", img)
        print("Screenshot saved to /tmp/dialog_open.png")
